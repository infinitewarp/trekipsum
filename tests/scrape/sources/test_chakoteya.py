...
def test_parse_script_mock_tos():
    ...
    expected_speakers = {'SPORK', 'SOLO', 'DIRK', 'CHURCH', 'BONES', 'DIRK/SPORK'}
    ...
    assert len(parsed_dialog['DIRK/SPORK']) == 1
    ...
    assert 'twenty-eight twenty-nine.' in parsed_dialog['DIRK/SPORK']
